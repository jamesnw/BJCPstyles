  ...
  }, 
  {
    ...
    "subcategories": [
      ...
      }, 
      {
        ...
        "commercial_examples": [
          "Bohemian Brewery Cherny Bock 4%, Budweiser Budvar B:Dark tmav\u00fd le\u017e\u00e1k, Devils Backbone Morana, Kout na \u0160umav\u011b Koutsk\u00fd tmav\u00fd speci\u00e1l 14\u00b0, Notch \u010cern\u00e9 Pivo, Pivovar B\u0159eznice Herold", 
        ...
        "subcategories": [
          {
            ...
            "commercial_examples": [
              ...
              "Hofbrau Munchner Sommer Naturtrub, Wolnzacher Hell Naturtr\u00fcb"
            ], 
            "description": "A very common seasonal summer beer brewed by many of the Munich area breweries and served in the beer gardens, where they are very popular.", 
            ...
            "tags": [
              "standard-strength, pale-color, bottom-fermented, central-europe, traditional-style, balanced, pale-lager-family"
            ], 
            "vital_statistics": {
              "abv": {
                "high": "5.4", 
          ...
          }, 
          {
            ...
            "intro": "The original style of Kellerbier from the Franconia area of Germany. A much older style compared to the relatively more recent pale Helles-Style Kellerbier that is popular in the Munich area today.", 
    ...
    "subcategories": [
      ...
      }, 
      {
        ...
        "commercial_examples": [
          ...
          "Shepherd Neame Master Brew Kentish Ale, Timothy Taylor Landlord,  Young\u2019s Special"
        ], 
        "flavor": "Medium to moderately high bitterness. Moderately low to moderately high fruity esters. Moderate to low hop flavor, typically with an earthy, resiny, fruity, and/or floral character. Low to medium maltiness with a dry finish. The malt profile is typically bready, biscuity, or lightly toasty. Low to moderate caramel or toffee flavors are optional. Balance is often decidedly bitter, although the bitterness should not completely overpower the malt flavor, esters and hop flavor. Generally no diacetyl, although very low levels are allowed.", 
        "history": "See comments in category introduction.", 
        "letter": "B", 
    ...
    "subcategories": [
      {
        ...
        "style_comparison": "Some versions may seem like lower-gravity modern English porters. Much less sweet than London Brown Ale.", 
        "tags": [
          "session-strength", 
          "dark-color", 
          "top-fermented", 
      ...
      }, 
      {
        ...
        "description": "Simply called \u201cPorter\u201d in Britain, the name \u201cEnglish Porter\u201d is used to differentiate it from other porters described in these guidelines.", 
    ...
    "subcategories": [
      ...
      }, 
      {
        ...
        "commercial_examples": [
          ...
          "Brooklyn Brown Ale", 
          "Bell\u2019s Best Brown, Cigar City Maduro Brown Ale, Smuttynose Old Brown Dog Ale, Telluride Face Down Brown"
        ], 
    ...
    "subcategories": [
      {
        ...
        "commercial_examples": [
          ...
          "Deschutes Black Butte Porter, Founders Porter, Great Lakes Edmund Fitzgerald Porter, Smuttynose Robust Porter, Sierra Nevada Porter"
        ], 
    ...
    "subcategories": [
      ...
      }, 
      {
        ...
        "commercial_examples": [
          ...
          "Port Brewing Shark Attack Double Red, Stone Arrogant Bastard"
        ], 
        ...
        "style_comparison": "Generally not as strong and as rich as an American Barleywine. More malt balanced than an American or Double IPA with more American hop intensity than an English Strong Ale style would tolerate.", 
        "tags": [
    ...
    "subcategories": [
      {
        ...
        "commercial_examples": [
          "Allagash White", 
          "Blanche de Bruxelles, Celis White, Hoegaarden Wit, Ommegang Witte, St. Bernardus Witbier, Wittekerke"
        ], 
    ...
    "subcategories": [
      ...
      }, 
      {
        "Commercial Examples": [
          ...
          "Gouden Carolus Grand Cru of the Emperor Rochefort 8 &amp; 10, St. Bernardus Abt 12, Westvleteren 12"
        ], 
  ...
  }, 
  {
    ...
    "subcategories": [
      ...
      }, 
      {
        ...
        "Vital Statistics": "Variable by styleCommercial Examples: Boulevard Love Child, Cascade Vlad the Imp Aler, Jester King Le Petit Prince, Jolly Pumpkin Calabaza Blanca, Russian River Temptation, The Bruery Rueuze, The Bruery Tart of Darkness", 
        "letter": "B", 
    ...
    "subcategories": [
      {
        ...
        "Overall Impression": "A harmonious marriage of fruit and beer, but still recognizable as a beer. The fruit character should be evident but in balance with the beer, not so forward as to suggest an artificial product.Aroma: The distinctive aromatics associated with the declared fruit should be noticeable in the aroma; however, note that some fruit (e.g., raspberries, cherries) have stronger aromas and are more distinctive than others (e.g., blueberries, strawberries) \u2013 allow for a range of fruit character and intensity from subtle to aggressive. The additional aromatics should blend well with whatever aromatics are appropriate for the declared base beer style.", 
        "Vital Statistics": "OG, FG, IBUs, SRM and ABV will vary depending on the underlying base beer, but the fruit will often be reflected in the color.Commercial Examples: Bell\u2019s Cherry Stout, Dogfish Head Aprihop, Ebulum Elderberry Black Ale, Founders R\u00fcb\u00e6us", 
        "description": "See the Introduction to Specialty-Type Beer section for additional comments, particularly on evaluating the balance of added ingredients with the base beer.", 
        "name": "Fruit Beer", 
        "tags": [
      ...
      }, 
      {
        ...
        "Vital Statistics": "OG, FG, IBUs, SRM and ABV will vary depending on the underlying base beer, but the fruit will often be reflected in the color.", 
        "description": "A Specialty Fruit Beer is a fruit beer with some additional ingredients or processes, such as fermentable sugars (honey, brown sugar, invert sugar, etc.) added. See the Introduction to Specialty-Type Beer section for additional comments, particularly on evaluating the balance of added ingredients with the base beer.", 
        "letter": "C", 
    ...
    "subcategories": [
      ...
      }, 
      {
        ...
        "commercial_examples": [
          ...
          "Goose Island Christmas Ale, Great Lakes Christmas Ale, Harpoon Winter Warmer, Lakefront Holiday Spice Lager Beer, Weyerbacher Winter Ale"
        ], 
    ...
    "subcategories": [
      {
        ...
        "Entry Instructions": "The entrant must specify a base style, but the declared style does not have to be a Classic Style. The entrant must specify the type of alternative grain used. Vital Statistics: OG, FG, IBUs, SRM and ABV will vary depending on the underlying base beer.", 
        ...
        "commercial_examples": [
          ...
          "Lakefront New Grist, New Planet Pale Ale"
        ], 
      ...
      {
        "Appearance": "Same as the base beer, although some sugars will bring additional colors.Flavor: Same as the base beer, except that some additional fermentables (honey, molasses, etc.) may add a flavor component. Whatever additional flavor component is present should be in balance with the beer components, and be a pleasant combination. Added sugars should not have a raw, unfermented flavor. Some added sugars will have unfermentable elements that may provide a fuller finish; fully fermentable sugars may thin out the finish.", 
    ...
    "subcategories": [
      {
        ...
        "commercial_examples": [
          ...
          "Schlenkerla Weizen Rauchbier and Ur-Bock Rauchbier, Spezial Lagerbier, Weissbier and Bockbier, Stone Smoked Porter"
        ], 
      ...
      }, 
      {
        ...
        "Vital Statistics": "Varies with the base beer style.", 
        "intro": "A Specialty Smoked Beer is either a smoked beer based on something other than a Classic Style, or any type of smoked beer with additional ingredients (fruits, vegetables, spices) or processes employed that transform the beer into something more unique.", 
        "letter": "B", 
    ...
    "subcategories": [
      {
        ...
        "intro": "This style is intended for beer aged in wood without added alcohol character from previous use of the barrel. Bourbon-barrel or other similar beers should be entered as a Specialty Wood-Aged Beer.", 
        "letter": "A", 
        "name": "Wood-Aged Beer", 
        "tags": [
          "specialty-beer, wood"
  ...
  }, 
  {
    ...
    "subcategories": [
      ...
      }, 
      {
        ...
        "description": "This style is intended for combinations of existing styles (Classic Beers or Specialty-Type) that are not defined elsewhere in the guidelines. If a \u2018mixed-style beer\u2019 does fit another style, do not enter it here.", 
        "letter": "B", 
      ...
      }, 
      {
        ...
        "intro": "This is explicitly a catch-all category for any beer that does not fit into an existing style description. No beer is ever \u201cout of style\u201d in this style, unless it fits elsewhere. This is the last resort for any beer entered into a competition.", 
        "letter": "C", 
